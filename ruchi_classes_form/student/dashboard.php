...
.sidebar.collapsed .logo-text span {
  display: none; /* Ensure span is also hidden */
}
  ...
  <span>Education for Excellence</span>
    ...
    <div class="main-content" id="mainContent">
      ...
      <div class="card">
        ...
        <p style="color: var(--text-secondary);">Your schedule and upcoming classes will appear here with timing and subject details.</p>
      </div>
    </div>
  </div>
